...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000495ecba8000000006b876ca5(
...
class phpbbtemplatetwiglexer_00000000495ecba8000000006b876ca5 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5deacdc82c734971085644 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5deacdc82c73d503431326 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5deacdc82c716806091151 = array(
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, 'set_environment', array('env' => $env), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        return $this->valueHolder5deacdc82c734971085644->set_environment($env);
    }
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        return $this->valueHolder5deacdc82c734971085644->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        return $this->valueHolder5deacdc82c734971085644->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5deacdc82c73d503431326 = $initializer;
    }
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__get', array('name' => $name), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        if (isset(self::$publicProperties5deacdc82c716806091151[$name])) {
            return $this->valueHolder5deacdc82c734971085644->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5deacdc82c734971085644;
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__isset', array('name' => $name), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__unset', array('name' => $name), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;
    ...
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__clone', array(), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        $this->valueHolder5deacdc82c734971085644 = clone $this->valueHolder5deacdc82c734971085644;
    }

    public function __sleep()
    {
        $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, '__sleep', array(), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;

        return array('valueHolder5deacdc82c734971085644');
    }
    ...
    {
        return $this->initializer5deacdc82c73d503431326;
    }
    ...
    {
        return $this->initializer5deacdc82c73d503431326 && ($this->initializer5deacdc82c73d503431326->__invoke($valueHolder5deacdc82c734971085644, $this, 'initializeProxy', array(), $this->initializer5deacdc82c73d503431326) || 1) && $this->valueHolder5deacdc82c734971085644 = $valueHolder5deacdc82c734971085644;
    }
    ...
    {
        return null !== $this->valueHolder5deacdc82c734971085644;
    }
    ...
    {
        return $this->valueHolder5deacdc82c734971085644;
    }
