...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'blitze.sitemaker.auto_lang' => 'getBlitze_Sitemaker_AutoLangService',
            'blitze.sitemaker.block.attachments' => 'getBlitze_Sitemaker_Block_AttachmentsService',
            'blitze.sitemaker.block.birthday' => 'getBlitze_Sitemaker_Block_BirthdayService',
            'blitze.sitemaker.block.custom' => 'getBlitze_Sitemaker_Block_CustomService',
            'blitze.sitemaker.block.featured_member' => 'getBlitze_Sitemaker_Block_FeaturedMemberService',
            'blitze.sitemaker.block.forum_poll' => 'getBlitze_Sitemaker_Block_ForumPollService',
            'blitze.sitemaker.block.forum_topics' => 'getBlitze_Sitemaker_Block_ForumTopicsService',
            'blitze.sitemaker.block.links' => 'getBlitze_Sitemaker_Block_LinksService',
            'blitze.sitemaker.block.login' => 'getBlitze_Sitemaker_Block_LoginService',
            'blitze.sitemaker.block.member_menu' => 'getBlitze_Sitemaker_Block_MemberMenuService',
            'blitze.sitemaker.block.menu' => 'getBlitze_Sitemaker_Block_MenuService',
            'blitze.sitemaker.block.mybookmarks' => 'getBlitze_Sitemaker_Block_MybookmarksService',
            'blitze.sitemaker.block.stats' => 'getBlitze_Sitemaker_Block_StatsService',
            'blitze.sitemaker.block.style_switcher' => 'getBlitze_Sitemaker_Block_StyleSwitcherService',
            'blitze.sitemaker.block.whats_new' => 'getBlitze_Sitemaker_Block_WhatsNewService',
            'blitze.sitemaker.block.whois' => 'getBlitze_Sitemaker_Block_WhoisService',
            'blitze.sitemaker.block.wordgraph' => 'getBlitze_Sitemaker_Block_WordgraphService',
            'blitze.sitemaker.block_collection' => 'getBlitze_Sitemaker_BlockCollectionService',
            'blitze.sitemaker.blocks' => 'getBlitze_Sitemaker_BlocksService',
            'blitze.sitemaker.blocks.action_handler' => 'getBlitze_Sitemaker_Blocks_ActionHandlerService',
            'blitze.sitemaker.blocks.admin.controller' => 'getBlitze_Sitemaker_Blocks_Admin_ControllerService',
            'blitze.sitemaker.blocks.admin_bar' => 'getBlitze_Sitemaker_Blocks_AdminBarService',
            'blitze.sitemaker.blocks.cfg_handler' => 'getBlitze_Sitemaker_Blocks_CfgHandlerService',
            'blitze.sitemaker.blocks.display' => 'getBlitze_Sitemaker_Blocks_DisplayService',
            'blitze.sitemaker.blocks.factory' => 'getBlitze_Sitemaker_Blocks_FactoryService',
            'blitze.sitemaker.blocks.manager' => 'getBlitze_Sitemaker_Blocks_ManagerService',
            'blitze.sitemaker.blocks.members' => 'getBlitze_Sitemaker_Blocks_MembersService',
            'blitze.sitemaker.cron.blocks_cleanup' => 'getBlitze_Sitemaker_Cron_BlocksCleanupService',
            'blitze.sitemaker.date_range' => 'getBlitze_Sitemaker_DateRangeService',
            'blitze.sitemaker.event.listener' => 'getBlitze_Sitemaker_Event_ListenerService',
            'blitze.sitemaker.event.sitemaker' => 'getBlitze_Sitemaker_Event_SitemakerService',
            'blitze.sitemaker.event.startpage' => 'getBlitze_Sitemaker_Event_StartpageService',
            'blitze.sitemaker.filemanager.settings' => 'getBlitze_Sitemaker_Filemanager_SettingsService',
            'blitze.sitemaker.filemanager.setup' => 'getBlitze_Sitemaker_Filemanager_SetupService',
            'blitze.sitemaker.forum.controller' => 'getBlitze_Sitemaker_Forum_ControllerService',
            'blitze.sitemaker.forum.data' => 'getBlitze_Sitemaker_Forum_DataService',
            'blitze.sitemaker.forum.manager' => 'getBlitze_Sitemaker_Forum_ManagerService',
            'blitze.sitemaker.forum.options' => 'getBlitze_Sitemaker_Forum_OptionsService',
            'blitze.sitemaker.groups' => 'getBlitze_Sitemaker_GroupsService',
            'blitze.sitemaker.icon_picker' => 'getBlitze_Sitemaker_IconPickerService',
            'blitze.sitemaker.mapper.factory' => 'getBlitze_Sitemaker_Mapper_FactoryService',
            'blitze.sitemaker.members' => 'getBlitze_Sitemaker_MembersService',
            'blitze.sitemaker.menus.action_handler' => 'getBlitze_Sitemaker_Menus_ActionHandlerService',
            'blitze.sitemaker.menus.admin.controller' => 'getBlitze_Sitemaker_Menus_Admin_ControllerService',
            'blitze.sitemaker.menus.display' => 'getBlitze_Sitemaker_Menus_DisplayService',
            'blitze.sitemaker.menus.navigation' => 'getBlitze_Sitemaker_Menus_NavigationService',
            'blitze.sitemaker.poll' => 'getBlitze_Sitemaker_PollService',
            'blitze.sitemaker.template' => 'getBlitze_Sitemaker_TemplateService',
            'blitze.sitemaker.template.twig.environment' => 'getBlitze_Sitemaker_Template_Twig_EnvironmentService',
            'blitze.sitemaker.template.twig.loader' => 'getBlitze_Sitemaker_Template_Twig_LoaderService',
            'blitze.sitemaker.template_context' => 'getBlitze_Sitemaker_TemplateContextService',
            'blitze.sitemaker.upload.controller' => 'getBlitze_Sitemaker_Upload_ControllerService',
            'blitze.sitemaker.url_checker' => 'getBlitze_Sitemaker_UrlCheckerService',
            'blitze.sitemaker.users.data' => 'getBlitze_Sitemaker_Users_DataService',
            'blitze.sitemaker.util' => 'getBlitze_Sitemaker_UtilService',
            ...
            'dmzx.mchat.acp.controller' => 'getDmzx_Mchat_Acp_ControllerService',
            'dmzx.mchat.acp.listener' => 'getDmzx_Mchat_Acp_ListenerService',
            'dmzx.mchat.core' => 'getDmzx_Mchat_CoreService',
            'dmzx.mchat.cron.task.mchat_prune' => 'getDmzx_Mchat_Cron_Task_MchatPruneService',
            'dmzx.mchat.functions' => 'getDmzx_Mchat_FunctionsService',
            'dmzx.mchat.log' => 'getDmzx_Mchat_LogService',
            'dmzx.mchat.main.listener' => 'getDmzx_Mchat_Main_ListenerService',
            'dmzx.mchat.notifications' => 'getDmzx_Mchat_NotificationsService',
            'dmzx.mchat.settings' => 'getDmzx_Mchat_SettingsService',
            'dmzx.mchat.text_reparser.mchat_messages' => 'getDmzx_Mchat_TextReparser_MchatMessagesService',
            'dmzx.mchat.text_reparser.reparser' => 'getDmzx_Mchat_TextReparser_ReparserService',
            'dmzx.mchat.ucp.controller' => 'getDmzx_Mchat_Ucp_ControllerService',
            ...
            'hifikabin.rightheaderimage.listener' => 'getHifikabin_Rightheaderimage_ListenerService',
    ...
    /**
     * Gets the public 'blitze.sitemaker.auto_lang' shared service.
     *
     * @return \blitze\sitemaker\services\auto_lang
     */
    protected function getBlitze_Sitemaker_AutoLangService()
    {
        return $this->services['blitze.sitemaker.auto_lang'] = new \blitze\sitemaker\services\auto_lang($this->get('config'), $this->get('ext.manager'), $this->get('language'), $this->get('user'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.block.attachments' shared service.
     *
     * @return \blitze\sitemaker\blocks\attachments
     */
    protected function getBlitze_Sitemaker_Block_AttachmentsService()
    {
        $this->services['blitze.sitemaker.block.attachments'] = $instance = new \blitze\sitemaker\blocks\attachments($this->get('auth'), $this->get('cache'), $this->get('blitze.sitemaker.date_range'), $this->get('blitze.sitemaker.forum.data'), $this->get('blitze.sitemaker.forum.options'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.attachments');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.birthday' shared service.
     *
     * @return \blitze\sitemaker\blocks\birthday
     */
    protected function getBlitze_Sitemaker_Block_BirthdayService()
    {
        $this->services['blitze.sitemaker.block.birthday'] = $instance = new \blitze\sitemaker\blocks\birthday($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('template'), $this->get('user'));

        $instance->set_name('blitze.sitemaker.block.birthday');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.custom' shared service.
     *
     * @return \blitze\sitemaker\blocks\custom
     */
    protected function getBlitze_Sitemaker_Block_CustomService()
    {
        $this->services['blitze.sitemaker.block.custom'] = $instance = new \blitze\sitemaker\blocks\custom($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('request'), 'phpbb_sm_cblocks');

        $instance->set_name('blitze.sitemaker.block.custom');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.featured_member' shared service.
     *
     * @return \blitze\sitemaker\blocks\featured_member
     */
    protected function getBlitze_Sitemaker_Block_FeaturedMemberService()
    {
        $this->services['blitze.sitemaker.block.featured_member'] = $instance = new \blitze\sitemaker\blocks\featured_member($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('language'), $this->get('blitze.sitemaker.users.data'), 'phpbb_sm_blocks');

        $instance->set_name('blitze.sitemaker.block.featured_member');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.forum_poll' shared service.
     *
     * @return \blitze\sitemaker\blocks\forum_poll
     */
    protected function getBlitze_Sitemaker_Block_ForumPollService()
    {
        $this->services['blitze.sitemaker.block.forum_poll'] = $instance = new \blitze\sitemaker\blocks\forum_poll($this->get('dbal.conn'), $this->get('blitze.sitemaker.forum.data'), $this->get('blitze.sitemaker.forum.options'), $this->get('blitze.sitemaker.groups'), $this->get('blitze.sitemaker.poll'));

        $instance->set_name('blitze.sitemaker.block.forum_poll');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.forum_topics' shared service.
     *
     * @return \blitze\sitemaker\blocks\forum_topics
     */
    protected function getBlitze_Sitemaker_Block_ForumTopicsService()
    {
        $this->services['blitze.sitemaker.block.forum_topics'] = $instance = new \blitze\sitemaker\blocks\forum_topics($this->get('auth'), $this->get('content.visibility'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.date_range'), $this->get('blitze.sitemaker.forum.data'), $this->get('blitze.sitemaker.forum.options'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.forum_topics');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.links' shared service.
     *
     * @return \blitze\sitemaker\blocks\links
     */
    protected function getBlitze_Sitemaker_Block_LinksService()
    {
        $this->services['blitze.sitemaker.block.links'] = $instance = new \blitze\sitemaker\blocks\links($this->get('language'), $this->get('blitze.sitemaker.menus.navigation'));

        $instance->set_name('blitze.sitemaker.block.links');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.login' shared service.
     *
     * @return \blitze\sitemaker\blocks\login
     */
    protected function getBlitze_Sitemaker_Block_LoginService()
    {
        $this->services['blitze.sitemaker.block.login'] = $instance = new \blitze\sitemaker\blocks\login($this, $this->get('template'), $this->get('user'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.login');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.member_menu' shared service.
     *
     * @return \blitze\sitemaker\blocks\member_menu
     */
    protected function getBlitze_Sitemaker_Block_MemberMenuService()
    {
        $this->services['blitze.sitemaker.block.member_menu'] = $instance = new \blitze\sitemaker\blocks\member_menu($this->get('auth'), $this->get('user'), $this->get('blitze.sitemaker.forum.data'), $this->get('blitze.sitemaker.util'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.member_menu');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.menu' shared service.
     *
     * @return \blitze\sitemaker\blocks\menu
     */
    protected function getBlitze_Sitemaker_Block_MenuService()
    {
        $this->services['blitze.sitemaker.block.menu'] = $instance = new \blitze\sitemaker\blocks\menu($this->get('language'), $this->get('blitze.sitemaker.menus.navigation'));

        $instance->set_name('blitze.sitemaker.block.links');
        $instance->set_name('blitze.sitemaker.block.menu');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.mybookmarks' shared service.
     *
     * @return \blitze\sitemaker\blocks\mybookmarks
     */
    protected function getBlitze_Sitemaker_Block_MybookmarksService()
    {
        $this->services['blitze.sitemaker.block.mybookmarks'] = $instance = new \blitze\sitemaker\blocks\mybookmarks($this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.forum.data'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.mybookmarks');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.stats' shared service.
     *
     * @return \blitze\sitemaker\blocks\stats
     */
    protected function getBlitze_Sitemaker_Block_StatsService()
    {
        $this->services['blitze.sitemaker.block.stats'] = $instance = new \blitze\sitemaker\blocks\stats($this->get('config'), $this->get('template'), $this->get('language'));

        $instance->set_name('blitze.sitemaker.block.stats');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.style_switcher' shared service.
     *
     * @return \blitze\sitemaker\blocks\style_switcher
     */
    protected function getBlitze_Sitemaker_Block_StyleSwitcherService()
    {
        $this->services['blitze.sitemaker.block.style_switcher'] = $instance = new \blitze\sitemaker\blocks\style_switcher($this->get('blitze.sitemaker.blocks.display'));

        $instance->set_name('blitze.sitemaker.block.style_switcher');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.whats_new' shared service.
     *
     * @return \blitze\sitemaker\blocks\whats_new
     */
    protected function getBlitze_Sitemaker_Block_WhatsNewService()
    {
        $this->services['blitze.sitemaker.block.whats_new'] = $instance = new \blitze\sitemaker\blocks\whats_new($this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.forum.data'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.whats_new');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.whois' shared service.
     *
     * @return \blitze\sitemaker\blocks\whois
     */
    protected function getBlitze_Sitemaker_Block_WhoisService()
    {
        $this->services['blitze.sitemaker.block.whois'] = $instance = new \blitze\sitemaker\blocks\whois($this->get('auth'), $this->get('config'), $this->get('language'), $this->get('template'), $this->get('user'), './../', 'php');

        $instance->set_name('blitze.sitemaker.block.whois');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block.wordgraph' shared service.
     *
     * @return \blitze\sitemaker\blocks\wordgraph
     */
    protected function getBlitze_Sitemaker_Block_WordgraphService()
    {
        $this->services['blitze.sitemaker.block.wordgraph'] = $instance = new \blitze\sitemaker\blocks\wordgraph($this->get('dbal.conn'), $this->get('blitze.sitemaker.forum.data'), './../', 'php', 10800);

        $instance->set_name('blitze.sitemaker.block.wordgraph');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.block_collection' shared service.
     *
     * @return \phpbb\di\service_collection
     */
    protected function getBlitze_Sitemaker_BlockCollectionService()
    {
        $this->services['blitze.sitemaker.block_collection'] = $instance = new \phpbb\di\service_collection($this);

        $instance->add('blitze.sitemaker.block.attachments');
        $instance->add('blitze.sitemaker.block.birthday');
        $instance->add('blitze.sitemaker.block.custom');
        $instance->add('blitze.sitemaker.block.featured_member');
        $instance->add('blitze.sitemaker.block.forum_poll');
        $instance->add('blitze.sitemaker.block.forum_topics');
        $instance->add('blitze.sitemaker.block.links');
        $instance->add('blitze.sitemaker.block.login');
        $instance->add('blitze.sitemaker.blocks.members');
        $instance->add('blitze.sitemaker.block.member_menu');
        $instance->add('blitze.sitemaker.block.menu');
        $instance->add('blitze.sitemaker.block.mybookmarks');
        $instance->add('blitze.sitemaker.block.stats');
        $instance->add('blitze.sitemaker.block.style_switcher');
        $instance->add('blitze.sitemaker.block.whats_new');
        $instance->add('blitze.sitemaker.block.whois');
        $instance->add('blitze.sitemaker.block.wordgraph');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\blocks
     */
    protected function getBlitze_Sitemaker_BlocksService()
    {
        return $this->services['blitze.sitemaker.blocks'] = new \blitze\sitemaker\services\blocks\blocks($this->get('cache.driver'), $this->get('config'), $this->get('dispatcher'), $this->get('template'), $this->get('language'), $this->get('blitze.sitemaker.blocks.factory'), $this->get('blitze.sitemaker.groups'), $this->get('blitze.sitemaker.mapper.factory'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.action_handler' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\action_handler
     */
    protected function getBlitze_Sitemaker_Blocks_ActionHandlerService()
    {
        return $this->services['blitze.sitemaker.blocks.action_handler'] = new \blitze\sitemaker\services\blocks\action_handler($this->get('config'), $this, $this->get('request'), $this->get('language'), $this->get('blitze.sitemaker.blocks'), $this->get('blitze.sitemaker.blocks.factory'), $this->get('blitze.sitemaker.mapper.factory'));
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.admin.controller' shared service.
     *
     * @return \blitze\sitemaker\controller\blocks_admin
     */
    protected function getBlitze_Sitemaker_Blocks_Admin_ControllerService()
    {
        return $this->services['blitze.sitemaker.blocks.admin.controller'] = new \blitze\sitemaker\controller\blocks_admin($this->get('auth'), $this->get('request'), $this->get('language'), $this->get('blitze.sitemaker.auto_lang'), $this->get('blitze.sitemaker.blocks.action_handler'));
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.admin_bar' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\admin_bar
     */
    protected function getBlitze_Sitemaker_Blocks_AdminBarService()
    {
        return $this->services['blitze.sitemaker.blocks.admin_bar'] = new \blitze\sitemaker\services\blocks\admin_bar($this->get('config'), $this->get('controller.helper'), $this, $this->get('dispatcher'), $this->get('template'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.filemanager.setup'), $this->get('blitze.sitemaker.icon_picker'), $this->get('blitze.sitemaker.util'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.cfg_handler' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\cfg_handler
     */
    protected function getBlitze_Sitemaker_Blocks_CfgHandlerService()
    {
        return $this->services['blitze.sitemaker.blocks.cfg_handler'] = new \blitze\sitemaker\services\blocks\cfg_handler($this->get('request'), $this->get('template'), $this->get('language'), $this->get('blitze.sitemaker.groups'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.display' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\display
     */
    protected function getBlitze_Sitemaker_Blocks_DisplayService()
    {
        return $this->services['blitze.sitemaker.blocks.display'] = new \blitze\sitemaker\services\blocks\display($this->get('auth'), $this->get('config'), $this->get('config_text'), $this, $this->get('request'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.factory' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\factory
     */
    protected function getBlitze_Sitemaker_Blocks_FactoryService()
    {
        return $this->services['blitze.sitemaker.blocks.factory'] = new \blitze\sitemaker\services\blocks\factory($this->get('language'), $this->get('blitze.sitemaker.template'), $this->get('blitze.sitemaker.block_collection'));
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.manager' shared service.
     *
     * @return \blitze\sitemaker\services\blocks\manager
     */
    protected function getBlitze_Sitemaker_Blocks_ManagerService()
    {
        return $this->services['blitze.sitemaker.blocks.manager'] = new \blitze\sitemaker\services\blocks\manager($this->get('cache.driver'), $this->get('blitze.sitemaker.blocks.factory'), $this->get('blitze.sitemaker.mapper.factory'));
    }

    /**
     * Gets the public 'blitze.sitemaker.blocks.members' shared service.
     *
     * @return \blitze\sitemaker\blocks\members
     */
    protected function getBlitze_Sitemaker_Blocks_MembersService()
    {
        $this->services['blitze.sitemaker.blocks.members'] = $instance = new \blitze\sitemaker\blocks\members($this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.members'));

        $instance->set_name('blitze.sitemaker.block.members');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.cron.blocks_cleanup' shared service.
     *
     * @return \blitze\sitemaker\cron\blocks_cleanup
     */
    protected function getBlitze_Sitemaker_Cron_BlocksCleanupService()
    {
        $this->services['blitze.sitemaker.cron.blocks_cleanup'] = $instance = new \blitze\sitemaker\cron\blocks_cleanup($this->get('config'), $this->get('dbal.conn'), $this->get('blitze.sitemaker.blocks.manager'), $this->get('blitze.sitemaker.url_checker'), 'phpbb_sm_blocks', 'phpbb_sm_cblocks');

        $instance->set_name('blitze.sitemaker.cron.blocks_cleanup');

        return $instance;
    }

    /**
     * Gets the public 'blitze.sitemaker.date_range' shared service.
     *
     * @return \blitze\sitemaker\services\date_range
     */
    protected function getBlitze_Sitemaker_DateRangeService()
    {
        return $this->services['blitze.sitemaker.date_range'] = new \blitze\sitemaker\services\date_range($this->get('user'));
    }

    /**
     * Gets the public 'blitze.sitemaker.event.listener' shared service.
     *
     * @return \blitze\sitemaker\event\listener
     */
    protected function getBlitze_Sitemaker_Event_ListenerService()
    {
        return $this->services['blitze.sitemaker.event.listener'] = new \blitze\sitemaker\event\listener($this, $this->get('language'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.event.sitemaker' shared service.
     *
     * @return \blitze\sitemaker\event\sitemaker
     */
    protected function getBlitze_Sitemaker_Event_SitemakerService()
    {
        return $this->services['blitze.sitemaker.event.sitemaker'] = new \blitze\sitemaker\event\sitemaker($this->get('cache.driver'), $this->get('config'), $this->get('template'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.util'), $this->get('blitze.sitemaker.blocks.display'), $this->get('blitze.sitemaker.menus.navigation'));
    }

    /**
     * Gets the public 'blitze.sitemaker.event.startpage' shared service.
     *
     * @return \blitze\sitemaker\event\startpage
     */
    protected function getBlitze_Sitemaker_Event_StartpageService()
    {
        return $this->services['blitze.sitemaker.event.startpage'] = new \blitze\sitemaker\event\startpage($this->get('config'), $this, $this->get('request'), $this->get('template'), $this->get('language'), $this->get('user'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.filemanager.settings' shared service.
     *
     * @return \blitze\sitemaker\services\filemanager\settings
     */
    protected function getBlitze_Sitemaker_Filemanager_SettingsService()
    {
        return $this->services['blitze.sitemaker.filemanager.settings'] = new \blitze\sitemaker\services\filemanager\settings($this->get('filesystem'), './../ResponsiveFilemanager/filemanager/config/', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.filemanager.setup' shared service.
     *
     * @return \blitze\sitemaker\services\filemanager\setup
     */
    protected function getBlitze_Sitemaker_Filemanager_SetupService()
    {
        return $this->services['blitze.sitemaker.filemanager.setup'] = new \blitze\sitemaker\services\filemanager\setup($this->get('auth'), $this->get('config'), $this->get('filesystem'), $this->get('user'), './../ResponsiveFilemanager/filemanager/config/', './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.forum.controller' shared service.
     *
     * @return \blitze\sitemaker\controller\forum
     */
    protected function getBlitze_Sitemaker_Forum_ControllerService()
    {
        return $this->services['blitze.sitemaker.forum.controller'] = new \blitze\sitemaker\controller\forum($this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('template'), $this->get('language'), $this->get('user'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.forum.data' shared service.
     *
     * @return \blitze\sitemaker\services\forum\data
     */
    protected function getBlitze_Sitemaker_Forum_DataService()
    {
        return $this->services['blitze.sitemaker.forum.data'] = new \blitze\sitemaker\services\forum\data($this->get('auth'), $this->get('config'), $this->get('content.visibility'), $this->get('dbal.conn'), $this->get('user'), $this->get('blitze.sitemaker.users.data'), 10800);
    }

    /**
     * Gets the public 'blitze.sitemaker.forum.manager' shared service.
     *
     * @return \blitze\sitemaker\services\forum\manager
     */
    protected function getBlitze_Sitemaker_Forum_ManagerService()
    {
        return $this->services['blitze.sitemaker.forum.manager'] = new \blitze\sitemaker\services\forum\manager($this->get('auth'), $this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), $this->get('language'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.forum.options' shared service.
     *
     * @return \blitze\sitemaker\services\forum\options
     */
    protected function getBlitze_Sitemaker_Forum_OptionsService()
    {
        return $this->services['blitze.sitemaker.forum.options'] = new \blitze\sitemaker\services\forum\options('./../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.groups' shared service.
     *
     * @return \blitze\sitemaker\services\groups
     */
    protected function getBlitze_Sitemaker_GroupsService()
    {
        return $this->services['blitze.sitemaker.groups'] = new \blitze\sitemaker\services\groups($this->get('dbal.conn'), $this->get('language'), $this->get('user'));
    }

    /**
     * Gets the public 'blitze.sitemaker.icon_picker' shared service.
     *
     * @return \blitze\sitemaker\services\icon_picker
     */
    protected function getBlitze_Sitemaker_IconPickerService()
    {
        return $this->services['blitze.sitemaker.icon_picker'] = new \blitze\sitemaker\services\icon_picker($this->get('language'), $this->get('blitze.sitemaker.util'), $this->get('blitze.sitemaker.template'));
    }

    /**
     * Gets the public 'blitze.sitemaker.mapper.factory' shared service.
     *
     * @return \blitze\sitemaker\model\mapper_factory
     */
    protected function getBlitze_Sitemaker_Mapper_FactoryService()
    {
        return $this->services['blitze.sitemaker.mapper.factory'] = new \blitze\sitemaker\model\mapper_factory($this->get('config'), $this->get('dbal.conn'), array('mappers' => array('blocks' => 'phpbb_sm_blocks', 'routes' => 'phpbb_sm_block_routes', 'menus' => 'phpbb_sm_menus', 'items' => 'phpbb_sm_menu_items')));
    }

    /**
     * Gets the public 'blitze.sitemaker.members' shared service.
     *
     * @return \blitze\sitemaker\services\members
     */
    protected function getBlitze_Sitemaker_MembersService()
    {
        return $this->services['blitze.sitemaker.members'] = new \blitze\sitemaker\services\members($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.date_range'), $this->get('blitze.sitemaker.template'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.menus.action_handler' shared service.
     *
     * @return \blitze\sitemaker\services\menus\action_handler
     */
    protected function getBlitze_Sitemaker_Menus_ActionHandlerService()
    {
        return $this->services['blitze.sitemaker.menus.action_handler'] = new \blitze\sitemaker\services\menus\action_handler($this->get('cache.driver'), $this->get('request'), $this->get('language'), $this->get('blitze.sitemaker.mapper.factory'));
    }

    /**
     * Gets the public 'blitze.sitemaker.menus.admin.controller' shared service.
     *
     * @return \blitze\sitemaker\controller\menus_admin
     */
    protected function getBlitze_Sitemaker_Menus_Admin_ControllerService()
    {
        return $this->services['blitze.sitemaker.menus.admin.controller'] = new \blitze\sitemaker\controller\menus_admin($this->get('auth'), $this->get('request'), $this->get('language'), $this->get('blitze.sitemaker.menus.action_handler'));
    }

    /**
     * Gets the public 'blitze.sitemaker.menus.display' service.
     *
     * @return \blitze\sitemaker\services\menus\display
     */
    protected function getBlitze_Sitemaker_Menus_DisplayService()
    {
        return new \blitze\sitemaker\services\menus\display($this->get('dbal.conn'), $this->get('user'), 'phpbb_sm_menu_items', 'item_id');
    }

    /**
     * Gets the public 'blitze.sitemaker.menus.navigation' shared service.
     *
     * @return \blitze\sitemaker\services\menus\navigation
     */
    protected function getBlitze_Sitemaker_Menus_NavigationService()
    {
        return $this->services['blitze.sitemaker.menus.navigation'] = new \blitze\sitemaker\services\menus\navigation($this->get('cache.driver'), $this->get('blitze.sitemaker.mapper.factory'), new \blitze\sitemaker\services\menus\display($this->get('dbal.conn'), $this->get('user'), 'phpbb_sm_menu_items', 'item_id'), 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.poll' shared service.
     *
     * @return \blitze\sitemaker\services\poll
     */
    protected function getBlitze_Sitemaker_PollService()
    {
        return $this->services['blitze.sitemaker.poll'] = new \blitze\sitemaker\services\poll($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.util'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.template' shared service.
     *
     * @return \blitze\sitemaker\services\template
     */
    protected function getBlitze_Sitemaker_TemplateService()
    {
        return $this->services['blitze.sitemaker.template'] = new \blitze\sitemaker\services\template($this->get('path_helper'), $this->get('config'), $this->get('blitze.sitemaker.template_context'), $this->get('blitze.sitemaker.template.twig.environment'), './../cache/production/twig/', $this->get('user'), $this->get('template.twig.extensions.collection'), $this->get('ext.manager'));
    }

    /**
     * Gets the public 'blitze.sitemaker.template.twig.environment' shared service.
     *
     * @return \phpbb\template\twig\environment
     */
    protected function getBlitze_Sitemaker_Template_Twig_EnvironmentService()
    {
        $this->services['blitze.sitemaker.template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), './../cache/production/twig/', $this->get('ext.manager'), $this->get('blitze.sitemaker.template.twig.loader'), $this->get('dispatcher'), array());
    ...
    /**
     * Gets the public 'blitze.sitemaker.template.twig.loader' shared service.
     *
     * @return \phpbb\template\twig\loader
     */
    protected function getBlitze_Sitemaker_Template_Twig_LoaderService()
    {
        return $this->services['blitze.sitemaker.template.twig.loader'] = new \phpbb\template\twig\loader($this->get('filesystem'));
    }

    /**
     * Gets the public 'blitze.sitemaker.template_context' shared service.
     *
     * @return \phpbb\template\context
     */
    protected function getBlitze_Sitemaker_TemplateContextService()
    {
        return $this->services['blitze.sitemaker.template_context'] = new \phpbb\template\context();
    }

    /**
     * Gets the public 'blitze.sitemaker.upload.controller' shared service.
     *
     * @return \blitze\sitemaker\controller\upload
     */
    protected function getBlitze_Sitemaker_Upload_ControllerService()
    {
        return $this->services['blitze.sitemaker.upload.controller'] = new \blitze\sitemaker\controller\upload($this->get('auth'), $this->get('files.factory'), $this->get('language'), $this->get('blitze.sitemaker.filemanager.setup'));
    }

    /**
     * Gets the public 'blitze.sitemaker.url_checker' shared service.
     *
     * @return \blitze\sitemaker\services\url_checker
     */
    protected function getBlitze_Sitemaker_UrlCheckerService()
    {
        return $this->services['blitze.sitemaker.url_checker'] = new \blitze\sitemaker\services\url_checker();
    }

    /**
     * Gets the public 'blitze.sitemaker.users.data' shared service.
     *
     * @return \blitze\sitemaker\services\users\data
     */
    protected function getBlitze_Sitemaker_Users_DataService()
    {
        return $this->services['blitze.sitemaker.users.data'] = new \blitze\sitemaker\services\users\data($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('profilefields.manager'), $this->get('language'), $this->get('user'), $this->get('blitze.sitemaker.util'), './../', 'php');
    }

    /**
     * Gets the public 'blitze.sitemaker.util' shared service.
     *
     * @return \blitze\sitemaker\services\util
     */
    protected function getBlitze_Sitemaker_UtilService()
    {
        return $this->services['blitze.sitemaker.util'] = new \blitze\sitemaker\services\util($this->get('path_helper'), $this->get('template'), $this->get('user'));
    }
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('blitze.sitemaker.cron.blocks_cleanup');
        $instance->add('dmzx.mchat.cron.task.mchat_prune');
        $instance->add('dmzx.mchat.text_reparser.reparser');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('blitze.sitemaker.event.listener', 'blitze\\sitemaker\\event\\listener');
        $instance->addSubscriberService('blitze.sitemaker.event.sitemaker', 'blitze\\sitemaker\\event\\sitemaker');
        $instance->addSubscriberService('blitze.sitemaker.event.startpage', 'blitze\\sitemaker\\event\\startpage');
        $instance->addSubscriberService('dmzx.mchat.acp.listener', 'dmzx\\mchat\\event\\acp_listener');
        $instance->addSubscriberService('dmzx.mchat.main.listener', 'dmzx\\mchat\\event\\main_listener');
        $instance->addSubscriberService('hifikabin.rightheaderimage.listener', 'hifikabin\\rightheaderimage\\event\\listener');
    ...
    /**
     * Gets the public 'dmzx.mchat.acp.controller' shared service.
     *
     * @return \dmzx\mchat\controller\acp_controller
     */
    protected function getDmzx_Mchat_Acp_ControllerService()
    {
        return $this->services['dmzx.mchat.acp.controller'] = new \dmzx\mchat\controller\acp_controller($this->get('dmzx.mchat.functions'), $this->get('template'), $this->get('log'), $this->get('user'), $this->get('language'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('request'), $this->get('dispatcher'), $this->get('dmzx.mchat.settings'));
    }

    /**
     * Gets the public 'dmzx.mchat.acp.listener' shared service.
     *
     * @return \dmzx\mchat\event\acp_listener
     */
    protected function getDmzx_Mchat_Acp_ListenerService()
    {
        return $this->services['dmzx.mchat.acp.listener'] = new \dmzx\mchat\event\acp_listener($this->get('template'), $this->get('request'), $this->get('language'), $this->get('dmzx.mchat.settings'), $this->get('dmzx.mchat.functions'));
    }

    /**
     * Gets the public 'dmzx.mchat.core' shared service.
     *
     * @return \dmzx\mchat\core\mchat
     */
    protected function getDmzx_Mchat_CoreService()
    {
        return $this->services['dmzx.mchat.core'] = new \dmzx\mchat\core\mchat($this->get('dmzx.mchat.functions'), $this->get('dmzx.mchat.notifications'), $this->get('dmzx.mchat.settings'), $this->get('dmzx.mchat.log'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('auth'), $this->get('pagination'), $this->get('request'), $this->get('dispatcher'), $this->get('ext.manager'), $this->get('text_formatter.s9e.parser'), NULL, NULL);
    }

    /**
     * Gets the public 'dmzx.mchat.cron.task.mchat_prune' shared service.
     *
     * @return \dmzx\mchat\cron\mchat_prune
     */
    protected function getDmzx_Mchat_Cron_Task_MchatPruneService()
    {
        $this->services['dmzx.mchat.cron.task.mchat_prune'] = $instance = new \dmzx\mchat\cron\mchat_prune($this->get('dmzx.mchat.functions'), $this->get('dmzx.mchat.settings'));

        $instance->set_name('cron.task.mchat_prune');

        return $instance;
    }

    /**
     * Gets the public 'dmzx.mchat.functions' shared service.
     *
     * @return \dmzx\mchat\core\functions
     */
    protected function getDmzx_Mchat_FunctionsService()
    {
        return $this->services['dmzx.mchat.functions'] = new \dmzx\mchat\core\functions($this->get('dmzx.mchat.settings'), $this->get('dmzx.mchat.notifications'), $this->get('dmzx.mchat.log'), $this->get('user'), $this->get('language'), $this->get('auth'), $this->get('log'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('dispatcher'), $this->get('group_helper'));
    }

    /**
     * Gets the public 'dmzx.mchat.log' shared service.
     *
     * @return \dmzx\mchat\core\log
     */
    protected function getDmzx_Mchat_LogService()
    {
        return $this->services['dmzx.mchat.log'] = new \dmzx\mchat\core\log($this->get('dmzx.mchat.settings'), $this->get('user'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('dispatcher'));
    }

    /**
     * Gets the public 'dmzx.mchat.main.listener' shared service.
     *
     * @return \dmzx\mchat\event\main_listener
     */
    protected function getDmzx_Mchat_Main_ListenerService()
    {
        return $this->services['dmzx.mchat.main.listener'] = new \dmzx\mchat\event\main_listener($this->get('dmzx.mchat.core'), $this->get('dmzx.mchat.notifications'), $this->get('controller.helper'), $this->get('user'), $this->get('language'), $this->get('request'), 'php');
    }

    /**
     * Gets the public 'dmzx.mchat.notifications' shared service.
     *
     * @return \dmzx\mchat\core\notifications
     */
    protected function getDmzx_Mchat_NotificationsService()
    {
        return $this->services['dmzx.mchat.notifications'] = new \dmzx\mchat\core\notifications($this->get('dmzx.mchat.settings'), $this->get('user'), $this->get('language'), $this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('text_formatter.s9e.parser'));
    }

    /**
     * Gets the public 'dmzx.mchat.settings' shared service.
     *
     * @return \dmzx\mchat\core\settings
     */
    protected function getDmzx_Mchat_SettingsService()
    {
        return $this->services['dmzx.mchat.settings'] = new \dmzx\mchat\core\settings($this->get('user'), $this->get('language'), $this->get('config'), $this->get('config_text'), $this->get('auth'), $this->get('dispatcher'), './../', 'php', 'phpbb_mchat', 'phpbb_mchat_log', 'phpbb_mchat_sessions');
    }

    /**
     * Gets the public 'dmzx.mchat.text_reparser.mchat_messages' shared service.
     *
     * @return \dmzx\mchat\textreparser\plugins\mchat_messages
     */
    protected function getDmzx_Mchat_TextReparser_MchatMessagesService()
    {
        $this->services['dmzx.mchat.text_reparser.mchat_messages'] = $instance = new \dmzx\mchat\textreparser\plugins\mchat_messages($this->get('dbal.conn'), 'phpbb_mchat');

        $instance->set_name('dmzx.mchat.text_reparser.mchat_messages');

        return $instance;
    }

    /**
     * Gets the public 'dmzx.mchat.text_reparser.reparser' shared service.
     *
     * @return \phpbb\cron\task\text_reparser\reparser
     */
    protected function getDmzx_Mchat_TextReparser_ReparserService()
    {
        $this->services['dmzx.mchat.text_reparser.reparser'] = $instance = new \phpbb\cron\task\text_reparser\reparser($this->get('config'), $this->get('config_text'), $this->get('text_reparser.lock'), $this->get('text_reparser.manager'), $this->get('text_reparser_collection'));

        $instance->set_name('dmzx.mchat.text_reparser.reparser');
        $instance->set_reparser('dmzx.mchat.text_reparser.mchat_messages');

        return $instance;
    }

    /**
     * Gets the public 'dmzx.mchat.ucp.controller' shared service.
     *
     * @return \dmzx\mchat\controller\ucp_controller
     */
    protected function getDmzx_Mchat_Ucp_ControllerService()
    {
        return $this->services['dmzx.mchat.ucp.controller'] = new \dmzx\mchat\controller\ucp_controller($this->get('template'), $this->get('user'), $this->get('language'), $this->get('auth'), $this->get('dbal.conn'), $this->get('request'), $this->get('dmzx.mchat.settings'), $this->get('dispatcher'));
    }
    ...
    /**
     * Gets the public 'hifikabin.rightheaderimage.listener' shared service.
     *
     * @return \hifikabin\rightheaderimage\event\listener
     */
    protected function getHifikabin_Rightheaderimage_ListenerService()
    {
        return $this->services['hifikabin.rightheaderimage.listener'] = new \hifikabin\rightheaderimage\event\listener($this->get('template'), $this->get('config'));
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003ef550fe000000003bb340bc(
    ...
    protected function getTextReparserCollectionService()
    {
        ...
        $instance->add('dmzx.mchat.text_reparser.mchat_messages');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.sitemaker.blocks' => 'phpbb_sm_blocks',
            'tables.sitemaker.block_routes' => 'phpbb_sm_block_routes',
            'tables.sitemaker.cblocks' => 'phpbb_sm_cblocks',
            'tables.sitemaker.menus' => 'phpbb_sm_menus',
            'tables.sitemaker.menu_items' => 'phpbb_sm_menu_items',
            'sitemaker.cache_time' => 10800,
            'filemanager.config_path' => './../ResponsiveFilemanager/filemanager/config/',
            'dmzx.mchat.table.mchat' => 'phpbb_mchat',
            'dmzx.mchat.table.mchat_log' => 'phpbb_mchat_log',
...
class phpbbtemplatetwiglexer_000000003ef550fe000000003bb340bc extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5deacdc904a93727167113 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5deacdc904a9c423745220 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5deacdc904a72019042079 = array(
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, 'set_environment', array('env' => $env), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        return $this->valueHolder5deacdc904a93727167113->set_environment($env);
    }
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        return $this->valueHolder5deacdc904a93727167113->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        return $this->valueHolder5deacdc904a93727167113->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5deacdc904a9c423745220 = $initializer;
    }
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__get', array('name' => $name), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        if (isset(self::$publicProperties5deacdc904a72019042079[$name])) {
            return $this->valueHolder5deacdc904a93727167113->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5deacdc904a93727167113;
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__isset', array('name' => $name), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__unset', array('name' => $name), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;
    ...
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__clone', array(), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        $this->valueHolder5deacdc904a93727167113 = clone $this->valueHolder5deacdc904a93727167113;
    }

    public function __sleep()
    {
        $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, '__sleep', array(), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;

        return array('valueHolder5deacdc904a93727167113');
    }
    ...
    {
        return $this->initializer5deacdc904a9c423745220;
    }
    ...
    {
        return $this->initializer5deacdc904a9c423745220 && ($this->initializer5deacdc904a9c423745220->__invoke($valueHolder5deacdc904a93727167113, $this, 'initializeProxy', array(), $this->initializer5deacdc904a9c423745220) || 1) && $this->valueHolder5deacdc904a93727167113 = $valueHolder5deacdc904a93727167113;
    }
    ...
    {
        return null !== $this->valueHolder5deacdc904a93727167113;
    }
    ...
    {
        return $this->valueHolder5deacdc904a93727167113;
    }
